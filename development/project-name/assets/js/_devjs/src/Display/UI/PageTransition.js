...
export default class PageTransition {
  ...
  switch() {
    ...
    this.isSwitch = false;
    gb.in.hash.state = 'transitionTo0' + (this.current);
    ...
    this.isSwitch = false;
    gb.in.hash.state = 'transitionTo0' + (this.current + 2);
  ...
  page03() {
    ...
    gb.in.hash.switchHash('interview');

  }

  page04() {

    gb.in.hash.switchHash('product');
  ...
  setEvents() {
    ...
    gb.in.s.add('pageTransition', this.onMouseWheel.bind(this));
